...
<script>
  export default{
    ...
    methods: {
      login() {
        this.$http.post('http://106.10.46.121:8888/auth/co/login',{user: this.user}).then((response)=>{
             alert('success');
        ...
        // this.$http.post('http://106.10.46.121:8888/aimsLogin/check',{userId: this.userId,password:this.password}).then((response)=>{
        //     alert('success');
        // },(error)=>{
        //     console.log('err')
        //     alert(error.response.data.error)
