  ...
  export default{
      ...
      methods: {
        ...
        applyList(order,semester){
          this.$http.get('http://106.10.46.121:8888/co/mypage/watchApplyStd',{params:{cLoginID : this.user.loginId, applyOrder: order,applySemester:semester }}).then((response) => {
        ...
        finishJudge(){
          ...
          this.$http.post('http://106.10.46.121:8888/co/mypage/changeYNApplyStd',{data:this.judgeStdinfo}).then((response)=>{
