...
<script>
  ...
  export default{
      ...
      created(){
        this.$http.get('http://10.41.83.255:8888/',{'headers': {authorization: `Bearer ${localStorage.token}`}}).then(res => {
      ...
      methods: {
        submitNotice(loginId){
                  ...
                  this.$http.get('http://10.41.83.255:8888/co/mypage/checkApplyNotice', {
                      params: {
                      ...
                      if (response.data == '1') {
                          ...
                          this.$http.post('http://10.41.83.255:8888/co/mypage/applyNotice', {
                              cLoginID: this.user.loginId,
                              data
                          }).then((response) => {
                              if (response.data == '1') {
